...
SELECT
    ...
    ,CASE
        WHEN (SD.SALESAMOUNT / SD.SALESQUANTITY = P.PRODUCTRETAILPRICE) 
            THEN (P.PRODUCTRETAILPROFIT * SD.SALESQUANTITY)
            ELSE (P.PRODUCTWHOLESALEUNITPROFIT * SD.SALESQUANTITY)
        END AS SALESTOTALPROFIT
